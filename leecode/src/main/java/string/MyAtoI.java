...
public class MyAtoI {
    ...
    public static void main(String[] args) {
        //"2147483648" "   +0 123" 2147483647
        MyAtoI test = new MyAtoI();
        System.out.println(test.myAtoi("42"));
        System.out.println(test.myAtoi("+-42"));
        System.out.println(test.myAtoi("0000+-42"));
        System.out.println(test.myAtoi("   0000+-42"));
    ...
    public int myAtoi(String s) {
        ...
        //判断符号位
        if(idx == n) return 0;
        if(chars[idx] == '-') { sign = -1; idx ++; }
        else if(chars[idx] == '+') { sign = 1; idx ++; }
        else if( chars[idx] < '0' || chars[idx] > '9') return 0;
        int res = 0;
